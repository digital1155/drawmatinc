...
function startMP4Recording() {
    ...
    try {
        ...
        app.mediaRecorder.onstop = () => {
            ...
            if (saveMP4Button) {
                saveMP4Button.innerHTML = '<img src="save-mp4-icon.png" alt="Save MP4 icon">';
        ...
        const saveMP4Button = document.getElementById('saveMP4');
        if (saveMP4Button) {
            saveMP4Button.innerHTML = '<img src="stop-recording-icon.png" alt="Stop recording icon">';
            ...
            toggleFullscreenBtn.addEventListener('click', () => {
                try {
                    if (!document.fullscreenElement) {
                        ...
                        toggleFullscreenBtn.innerHTML = '<img src="exit-fullscreen-icon.png" alt="Exit fullscreen icon">';
                        toggleFullscreenBtn.setAttribute('aria-label', 'Exit fullscreen mode');
                    } else {
                        document.exitFullscreen();
                        toggleFullscreenBtn.innerHTML = '<img src="fullscreen-icon.png" alt="Fullscreen icon">';
                        toggleFullscreenBtn.setAttribute('aria-label', 'Enter fullscreen mode');
                    }
                } catch (err) {
